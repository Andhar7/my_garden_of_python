...
print(f"\n📈 Difference in means: {np.mean(drug_group) - np.mean(placebo_group):.2f}")
...
plt.subplot(1, 2, 2)
plt.hist(drug_group, bins=15, alpha=0.6, label='Drug', color='green', edgecolor='black')
plt.hist(placebo_group, bins=15, alpha=0.6, label='Placebo', color='blue', edgecolor='black')
